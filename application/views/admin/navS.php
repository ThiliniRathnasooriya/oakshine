...
<div class="wrapper">
	...
	<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
		...
		<ul class="navbar-nav">
			...
			<li class="user_icon"><a type="button" title="sign up" data-toggle="modal" data-target="#registerModal"><i class="fa fa-user-plus" aria-hidden="true"></i></a></li>
		</ul>
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="#" class="brand-link">
			<!-- <img src="<?php echo base_url().'assets/images/images/logo4.png';?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
				 style="opacity: .8"> -->
			<span class="brand-text font-weight-light">Oakshine</span>
		</a>
		...
		<div class="sidebar">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<div class="image">
					<img src="<?php echo base_url().'assets/dist/img/we2.png';?>" class="img-circle elevation-2" alt="User Image">
				</div>
				<div class="info">
					<a href="#" class="d-block">Thilini</a>
				</div>
			</div>

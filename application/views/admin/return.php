			...
			<div class="container-fluid">
				<div class="row">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12" id="regID">
                        <div class="white-box">
                            <h3 class="box-title">Return Items In Stock</h3>
                            <div class="comment-center p-t-10">
							<table class="table table-hover">
						<thead>
							<tr class="table100-head">
								<th class="column1">Return ID</th>
								<th class="column2">Customer ID</th>
								<th class="column3">Supporter ID</th>
						...
						<tbody>
							<?php 
								foreach ($reg2 as $row){
									echo "<tr><td>". $row->return_id."</td><td>". $row->customer_id."</td><td>". $row->supporter_id."</td><td>". $row->item_id ."</td></tr>";

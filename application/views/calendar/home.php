				...
				<div class="row">
					...
					<section class="col-lg-12 connectedSortable">
                        ...
                        <div class="billing_details">
                            <h4 class="reg_title">Profit and loss report</h4>
							...
							<br>
							<h4 class="reg_title">Most and Least sold items</h4>
							...
							<br>
							<h4 class="reg_title">All employees' salary report</h4>
							...
							<br>
							<h4 class="reg_title">Salary slip for employees</h4>
							...
							<div class="form-group">
								...
								<button type="submit" name="view" value="select" class="btn btn-primary">Select</button>
							</div>
							</form>
                       </div>
							<!-- /.card-header -->
